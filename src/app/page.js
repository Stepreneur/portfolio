...
export default function Home() {
  ...
  return (
    <div>
      <Navbar />
      <div className="w-full flex items-center" style={{ backgroundColor: "oklch(0.2533 0.016 255.42)", height: "calc(100vh - 65px)" }}>
        <div className="w-full justify-center flex flex-row h-max gap-[50px]">
          ...
          <div className="text-4xl w-max flex flex-col gap-6">
            ...
            <div className="text-lg max-w-[500px] opacity-70">
              สวัสดีครับ! ผมชื่อ สเตฟาน (ธัญวรัตม์ ชัยนาม) อายุ 18 ปี <br />ปัจจุบันผมเป็นนักพัฒนาซอฟต์แวร์ที่หลงใหลในการสร้างเว็บไซต์และโปรเจกต์ต่างๆ <br />ด้วยเทคโนโลยีที่ผมเชี่ยวชาญ เช่น HTML, CSS, PHP, JavaScript, และ Next.js <br />ผมเริ่มต้นเรียนรู้การเขียนโค้ดมาได้ 2 ปีแล้ว และก็ได้ลงมือทำโปรเจกต์ของตัวเองมาอย่างจริงจัง
              สิ่งที่ผมเชื่อคือ การทำงานร่วมกับทีมคือหัวใจสำคัญของการสร้างสรรค์สิ่งใหม่ๆ ผมเชื่อว่าเทคโนโลยีสามารถเปลี่ยนแปลงโลกได้ และการที่เราได้สื่อสารกับเครื่องจักรหรือหุ่นยนต์จะช่วยให้เราแก้ปัญหาที่ยากและซับซ้อนได้ ทำให้ชีวิตของผู้คนดีขึ้นในหลายๆ ด้าน<br />
      ...
      <section className="flex flex-col mt-[40px]" style={{ backgroundColor: "oklch(0.2533 0.016 255.42)" }}>
        <div className="text-6xl w-full text-center font-bold">I'm a Website Developer</div>
      </section>
      <section>
      ...
      <section>
        ...
        <div className="w-full justify-center flex flex-col mt-[60px] gap-[20px]">
          ...
          <div className="flex flex-row justify-center gap-[30px]">
            <Image alt="loading" src="/img/css.png" width={50} height={50} style={{ objectFit: "contain" }} />
