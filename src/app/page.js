        ...
        <div className=" w-full flex items-center" style={{backgroundColor:" oklch(0.2533 0.016 255.42)", height: "calc(100vh - 65px)" }}> {/* Adjust height dynamically */}
          <div className="w-full justify-center flex flex-row h-max gap-[50px]">
            ...
            <div className="text-4xl w-max flex flex-col gap-6">
                ...
                <div className="text-lg max-w-[500px] opacity-70  ">สวัสดีครับ! ผมชื่อ สเตฟาน (ธัญวรัตม์ ชัยนาม) อายุ 18 ปี <br></br>ปัจจุบันผมเป็นนักพัฒนาซอฟต์แวร์ที่หลงใหลในการสร้างเว็บไซต์และโปรเจกต์ต่างๆ <br></br>ด้วยเทคโนโลยีที่ผมเชี่ยวชาญ เช่น HTML, CSS, PHP, JavaScript, และ Next.js <br></br>ผมเริ่มต้นเรียนรู้การเขียนโค้ดมาได้ 2 ปีแล้ว และก็ได้ลงมือทำโปรเจกต์ของตัวเองมาอย่างจริงจัง
                สิ่งที่ผมเชื่อคือ การทำงานร่วมกับทีมคือหัวใจสำคัญของการสร้างสรรค์สิ่งใหม่ๆ ผมเชื่อว่าเทคโนโลยีสามารถเปลี่ยนแปลงโลกได้ และการที่เราได้สื่อสารกับเครื่องจักรหรือหุ่นยนต์จะช่วยให้เราแก้ปัญหาที่ยากและซับซ้อนได้ ทำให้ชีวิตของผู้คนดีขึ้นในหลายๆด้าน<br></br>
                  เป้าหมายของผมในอนาคตคือการนำความรู้และประสบการณ์ที่มีมาสร้างสรรค์สิ่งดีๆ ที่สามารถช่วยเหลือและพัฒนาสังคม ผมพร้อมที่จะเรียนรู้และเติบโตไปพร้อมกับโอกาสใหม่ๆ</div>  
                ...
                <div className="flex flex-row w-max h-max  gap-[200px]">
                    <div className="flex flex-col items-end h-[400px] ml-[70px] gap-[25px] ">
                        ...
                        <div className="text-base mt-[10px]">เป็นสตาร์ทอัพที่ผมสร้างขึ้นมา
                          <br></br>โซเชียลเน็ตเวิร์คแพลตฟอร์มสำหรับนักเรียนในโรงเรียนเดียวกัน
                          <br></br>มีผู้ใช้มากกว่า 300 คน ในสัปดาห์แรก
                          <br></br>มีลูกทีมทั้งหมด 2 คน  
                        </div>
